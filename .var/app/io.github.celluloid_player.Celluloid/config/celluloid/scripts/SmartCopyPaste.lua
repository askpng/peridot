...
local linux_copy = '/usr/bin/wl-copy' --copy command that will be used in Linux. OR write a different command
local linux_paste = '/usr/bin/wl-paste' --paste command that will be used in Linux. OR write a different command
